...
namespace Axiom {
	...
	void ImGuiRenderer::Initialize(GLFWwindow* window) {
		...
		AIM_ASSERT(window != nullptr, "Window shouldn't be null!");
		...
		AIM_VERIFY(ImGui_ImplGlfw_InitForOpenGL(window, true), "Failed to init glfw for imgui!" );
	...
	void ImGuiRenderer::ApplyAxiomTheme() {
